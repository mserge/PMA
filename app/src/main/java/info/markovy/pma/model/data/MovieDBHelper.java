    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE =
                ...
                "CREATE TABLE " + MovieContract.MoviesEntry.TABLE_NAME + " (" +
                         ...
                         */
                        MovieContract.MoviesEntry.COLUMN_ID               + " INTEGER, " +
                        MovieContract.MoviesEntry.COLUMN_TITLE               + " TEXT, " +
                        MovieContract.MoviesEntry.COLUMN_POSTER              + " TEXT, " +

                        MovieContract.MoviesEntry.COLUMN_DATE       + " INTEGER NOT NULL, "                 +
                         ...
                         */
                        " UNIQUE (" + MovieContract.MoviesEntry.COLUMN_ID + ") ON CONFLICT REPLACE);";
